 ...
 * OpenAPI 文档处理器
 * <p>
 * 该处理器继承自 OpenAPIService，主要用于自定义和增强 OpenAPI 文档的生成逻辑。
 * 主要功能包括：
 * <ul>
 * <li>自定义 API 文档的标签（Tag）处理逻辑</li>
 * <li>支持从 Javadoc 注释中提取 API 描述信息</li>
 * <li>优化标签的命名和描述展示</li>
 * <li>处理安全相关配置</li>
 * <li>支持国际化的属性解析</li>
 * </ul>
 ...
 * 主要特性：
 * <ul>
 * <li>支持从类和方法级别的注解中提取标签信息</li>
 * <li>支持从 Javadoc 注释中自动生成 API 文档描述</li>
 * <li>提供标签去重和合并功能</li>
 * <li>支持自定义服务器 URL 配置</li>
 * <li>支持安全认证要求的配置</li>
 * </ul>
 * </p>
 *
 ...
 *       // ... 其他依赖
 *       ) {
 *       return new OpenApiHandler(openAPI, securityParser, properties, ...);
 *       }
 *       }
 *       }</pre>
 *       </p>
